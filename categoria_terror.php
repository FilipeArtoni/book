...
<body background="imagens/fundo.png">
    ...
    <div class="bg-light container container-frontal2" style="border: 3px solid black; width: 900px;">
        <h1 style="border-bottom: 5px dotted black">Livros de Terror</h1>
        <div class="row"> <!-- Início Row 1 -->
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/a_danca_da_morte_terror.png" />
                <h6 class="titulo">A Dança da Morte</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/amigo_imaginario_terror.png" />
                <h6 class="titulo">Amigo Imaginário</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/cemiterio_maldito_terror.png" />
                <h6 class="titulo">Cemitério Maldito</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Row Row 1 -->
        <div class="row"> <!-- Início Row 2 -->
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/it_a_coisa_terror.png" />
                <h6 class="titulo">It a Coisa</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/o_cemiterio_terror.png" />
                <h6 class="titulo">O Cemitério</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/o_despertar_do_anticristo_terror.png" />
                <h6 class="titulo">O Despertar do Anticristo</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 2 -->
        <div class="row"> <!-- Início Row 3 -->
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/o_exorcista_terror.png" />
                <h6 class="titulo">O Exocista</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/o_filho_do_acougueiro_terror.png" />
                <h6 class="titulo">O Filho do Açougueiro</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-terror">
                <img src="imagens/Terror/o_iluminado_terror.png" />
                <h6 class="titulo">O Iluminado</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 3 -->
        <div class="row"> <!-- Início Row 4 -->
            <div class="col-md-4">
                <img src="imagens/Terror/o_paciente_terror.png" />
                <h6 class="titulo">O Paciente</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Terror/o_vilarejo_terror.png" />
                <h6 class="titulo">O Vilarejo</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Terror/tripulacao_de_esqueletos_terror.png" />
                <h6 class="titulo">Tripulação de Esqueletos</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 4 -->
