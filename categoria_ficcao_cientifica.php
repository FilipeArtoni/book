...
<body background="imagens/fundo.png">
    ...
    <div class="bg-light container container-frontal2" style="border: 3px solid green; width: 900px;">
        <h1 style="border-bottom: 5px dotted green">Livros de Ficção Científica</h1>
        <div class="row"> <!-- Início Row 1 -->
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/a_guerra_dos_mundos_fc.png" />
                <h6 class="titulo">A Guerra dos Mundos</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/a_vida_secreta_de_jonas_fc.png" />
                <h6 class="titulo">A Vida Secreta de Jonas</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/abducoes_ovnis_aparicoes_fc.png" />
                <h6 class="titulo">Abduções Ovinis e Aparições</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Row Row 1 -->
        <div class="row"> <!-- Início Row 2 -->
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/dimensao_sci-fi_fc.png" />
                <h6 class="titulo">Dimensão Sci-Fi</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/guerra_mundial_z_fc.png" />
                <h6 class="titulo">Guerra Mundial Z</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/new_york_2140_fc.png" />
                <h6 class="titulo">New York 2140</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 2 -->
        <div class="row"> <!-- Início Row 3 -->
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/o_paraiso_das_lembancas_fc.png" />
                <h6 class="titulo">O Paraíso das Lembranças</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/origem_fc.png" />
                <h6 class="titulo">Origem</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-ficcaocientifica">
                <img src="imagens/FiccaoCientifica/padroes_de_contato_fc.png" />
                <h6 class="titulo">Padrões de Contato</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 3 -->
        <div class="row"> <!-- Início Row 4 -->
            <div class="col-md-4">
                <img src="imagens/FiccaoCientifica/uma_dobra_no_tempo_fc.png" />
                <h6 class="titulo">Uma Dobra no Tempo</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/FiccaoCientifica/uma_visao_da_ufologia_fc.png" />
                <h6 class="titulo">Uma Visão da Ufologia</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/FiccaoCientifica/visao_alienigena_fc.png" />
                <h6 class="titulo">Visão Alienígena</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 4 -->
    ...
    <div class="container container-lateral-direito bg-light" style="margin-top: -2000; margin-left: 500px; width: 220px;"> <!-- Fim Container Lateral-Direito -->
