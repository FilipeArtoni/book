...
<body background="imagens/fundo.png">
    ...
    <div class="container container-frontal" style="height: 1250px; margin-bottom: 300px"> <!-- Início Container Frontal -->
        <div class="row bg-light div-frontal"> <!-- Início Row -->

            <!-- Início Primeiro Carousel -->
            <div id="carouselExampleIndicators" class="carousel slide col-md-12" data-ride="carousel" style="height: 500px">
                <ol class="carousel-indicators">
                    <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
                    <li data-target="#carouselExampleIndicators" data-slide-to="1" class=""></li>
                    <li data-target="#carouselExampleIndicators" data-slide-to="2" class=""></li>
                </ol>
                <h4 class="col-md-12">Destaque: Livro Infantil</h4>
                <div class="carousel-inner col-md-12">
                    <div class="carousel-item active">
                        <a href="categoria_infantil.php">
                            <img class="col-md-12" src="imagens/Infantil/pinoquio_infant.png" />
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a href="categoria_infantil.php">
                            <img class="col-md-12" src="imagens/Infantil/chapeuzinho_vermelho_infant.png">
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a href="categoria_infantil.php">
                            <img class="col-md-12" src="imagens/Infantil/o_menino_que_olhava_para_o_ceu_infant.png">
                        </a>
                    </div>
                    <hr class="bg-dark" />
                </div>
            ...
            <!-- Fim Primeiro Carousel -->

            <!-- Início Segundo Carousel -->
            <div id="carouselExampleIndicators2" class="carousel slide col-md-12" data-ride="carousel" style="height: 500px">
                <ol class="carousel-indicators">
                ...
                <h4 class="col-md-12">Destaque: Livro de Terror</h4>
                <div class="carousel-inner col-md-12" style="height: 500px">
                    <div class="carousel-item active col-md-12">
                        <a href="categoria_terror.php">
                            <img src="imagens/Terror/o_paciente_terror.png" class="col-md-12" />
                        </a>
                    </div>
                    <div class="carousel-item col-md-12">
                        <a href="categoria_terror.php">
                            <img src="imagens/Terror/it_a_coisa_terror.png" class="col-md-12" />
                        </a>
                    </div>
                    <div class="carousel-item col-md-12">
                        <a href="categoria_terror.php">
                            <img src="imagens/Terror/o_exorcista_terror.png" class="col-md-12" />
                        </a>
                    </div>
                    <hr class="bg-dark" />
                </div>
            ...
            <!-- Início Terceiro Carousel -->
            <div id="carouselExampleIndicators3" class="carousel slide col-md-12" data-ride="carousel" style="height: 500px">
                <ol class="carousel-indicators">
                ...
                <h4 class="col-md-12">Destaque: Livro de Suspense</h4>
                <div class="carousel-inner col-md-12" style="height: 500px">
                    <div class="carousel-item active col-md-12">
                        <a href="categoria_suspense.php">
                            <img src="imagens/Suspense/o_canibal_de_nineelms_suspense.png" class="col-md-12" />
                        </a>
                    </div>
                    <div class="carousel-item col-md-12">
                        <a href="categoria_suspense.php">
                            <img src="imagens/Suspense/caixa_de_passaros_suspense.png" class="col-md-12" />
                        </a>
                    </div>
                    <div class="carousel-item col-md-12">
                        <a href="categoria_suspense.php">
                            <img src="imagens/Suspense/a_garota_do_lago_suspense.png" class="col-md-12" />
                        </a>
                    </div>
                    <hr class="bg-dark" />
                </div>
            ...
            <!-- Fim Terceiro Carousel -->

        </div> <!-- Fim Row -->
    </div> <!-- Fim Container Frontal -->

    <div class="container container-lateral-direito bg-light" style="margin-top: -1500; margin-left: 500px; width: 220px;"> <!-- Fim Container Lateral-Direito -->
