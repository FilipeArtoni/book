...
<body background="imagens/fundo.png">
    ...
    <div class="bg-light container container-frontal2" style="border: 3px solid gray; width: 900px;">
        <h1 style="border-bottom: 5px dotted gray">Livros de Suspense</h1>
        <div class="row"> <!-- Início Row 1 -->
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/a_garota_desaparecida_suspense.png" />
                <h6 class="titulo">A Garota Desaparecida</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/a_garota_do_lago_suspense.png" />
                <h6 class="titulo">A Garota do Lago</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/a_menina_silenciosa_suspense.png" />
                <h6 class="titulo">A Menina Silenciosa</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Row Row 1 -->
        <div class="row"> <!-- Início Row 2 -->
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/bem_atras_de_voce_suspense.png" />
                <h6 class="titulo">Bem Atrás de Você</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/caixa_de_passaros_suspense.png" />
                <h6 class="titulo">Caixa de Pássaros</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/nao_como_ele_parecia_suspense.png" />
                <h6 class="titulo">Não como Ele Parecia</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 2 -->
        <div class="row"> <!-- Início Row 3 -->
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/nao_como_ontem_suspense.png" />
                <h6 class="titulo">Não como Ontem</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/o_anjo_da_morte_suspense.png" />
                <h6 class="titulo">O Anjo da Morte</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-suspense">
                <img src="imagens/Suspense/o_canibal_de_nineelms_suspense.png" />
                <h6 class="titulo">O Canibal de Nineelms</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 3 -->
        <div class="row"> <!-- Início Row 4 -->
            <div class="col-md-4">
                <img src="imagens/Suspense/o_ultimo_suspiro_suspense.png" />
                <h6 class="titulo">O Último Suspiro</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Suspense/perto_de_casa_suspense.png" />
                <h6 class="titulo">Perto de Casa</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Suspense/sem_saida_suspense.png" />
                <h6 class="titulo">Sem Saída</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 4 -->
