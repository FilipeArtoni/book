...
<body background="imagens/fundo.png">
    ...
    <div class="bg-light container container-frontal2" style="border: 3px solid orange; width: 900px;">
        <h1 style="border-bottom: 5px dotted orange">Livros Infantis</h1>
        <div class="row"> <!-- Início Row 1 -->
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/bisa_bia_infant.png" />
                <h6 class="titulo">Bisa Bia, Bisa Bel</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/cade_os_bichos_infant.png" />
                <h6 class="titulo">Cadê os Bichos?</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/chapeuzinho_vermelho_infant.png" />
                <h6 class="titulo">Chapeuzinho Vermelho</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Row Row 1 -->
        <div class="row"> <!-- Início Row 2 -->
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/classicos_de_ouro_infant.png" />
                <h6 class="titulo">Clássicos de Ouro</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/o_mal_do_lobo_mau_infant.png" />
                <h6 class="titulo">O Mal do Lobo Mau</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/o_menino_maluquinho_infant.png" />
                <h6 class="titulo">O Menino Maluquinho</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 2 -->
        <div class="row"> <!-- Início Row 3 -->
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/o_menino_que_olhava_para_o_ceu_infant.png" />
                <h6 class="titulo">O Menino que Olhava para o Céu</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/os_bichos-me-contaram_infant.png" />
                <h6 class="titulo">Os Bichos Me Contaram</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-infantil">
                <img src="imagens/Infantil/os_vizinhos_infant.png" />
                <h6 class="titulo">Os Vizinhos</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 3 -->
        <div class="row"> <!-- Início Row 4 -->
            <div class="col-md-4">
                <img src="imagens/Infantil/pinoquio_infant.png" />
                <h6 class="titulo">Pinóquio</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Infantil/nao_quero_ler_infant.png" />
                <h6 class="titulo">Não Quero Ler</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Infantil/o_meu_pe_de_laranja_infant.png" />
                <h6 class="titulo">O Meu Pé de Laranja Lima</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 4 -->
