...
<body background="../imagens/fundo.png">
    ...
    <div class="container bg-light" style="padding: 30px; margin: 50px; height: 200px; width: 1000px;">
        <h3>Informações Corporativas</h3>
        <hr/>
        <p style="font-size: 1.1em;">O Book.com.br é um site de Varejo, onde se vende diversos livros e entrega para diversos lugares do Brasil.
            <br />Site feito para ESTUDO! 
        </p>
    </div>

    <div class="container container-lateral-direito bg-light" style="margin-top: -250; margin-left: 500px; width: 220px;"> <!-- Fim Container Lateral-Direito -->
            ...
            <div class="row text-light">
                ...
                <div class="col-6 col-lg-3 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="informacoes_corporativas.php">Informações corporativas</a>
                        </li>
                        <li class="mb-2">
                ...
                <div class="col-6 col-lg-3 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="publique_seus_livros.php">Publique seus livros</a>
                        </li>
                        <li class="mb-2">
                            <a href="seja_um_entregador.php">Seja um entregador</a>
                        </li>
                        <li>
                            <a href="seja_um_associado.php">Seja um associado</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-6 col-lg-3 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="meios_de_pagamento.php">Meios de pagamento</a>
                        </li>
                        <li>
                            <a href="compre_com_pontos.php">Compre com pontos</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-6 col-lg-3 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="sua_conta.php">Sua conta</a>
                        </li>
                        <li class="mb-2">
                            <a href="frete_e_prazo_entrega.php">Frete e prazo de entrega</a>
                        </li>
                        <li class="mb-2">
                            <a href="devolucoes_e_reembolsos.php">Devoluções e reembolsos</a>
                        </li>
                        <li>
