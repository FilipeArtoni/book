...
<body background="imagens/fundo.png">
    ...
    <div class="bg-light container container-frontal2" style="border: 3px solid pink; width: 900px;">
        <h1 style="border-bottom: 5px dotted pink">Livros de Romance</h1>
        <div class="row"> <!-- Início Row 1 -->
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/a_selecao_romance.png" />
                <h6 class="titulo">A Seleção</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/o_destino_romance.png" />
                <h6 class="titulo">O Destino</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/o_preco_de_uma_escolha_romance.png" />
                <h6 class="titulo">O Preço de uma Escolha</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Row Row 1 -->
        <div class="row"> <!-- Início Row 2 -->
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/redencao_total_romance.png" />
                <h6 class="titulo">Redenção Total</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/refens_do_tempo.png" />
                <h6 class="titulo">Reféns do Tempo</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/toque_de_coragem_romance.png" />
                <h6 class="titulo">Toque de Coragem</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 2 -->
        <div class="row"> <!-- Início Row 3 -->
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/um_romance_de_inverno_romance.png" />
                <h6 class="titulo">Um Romance de Inverno</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/um_romance_fora_de_epoca_romance.png" />
                <h6 class="titulo">Um Romance Fora de Época</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-romance">
                <img src="imagens/Romance/uma_desilusao_na_primavera_romance.png" />
                <h6 class="titulo">Uma Desilusão na Primavera</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 3 -->
        <div class="row"> <!-- Início Row 4 -->
            <div class="col-md-4">
                <img src="imagens/Romance/uma_paixao_de_outono_romance.png" />
                <h6 class="titulo">Uma Paixão de Outono</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Romance/uma_rendicao_no_verao_romance.png" />
                <h6 class="titulo">Uma Rendição no Verão</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Romance/uniao_entre_inimigos_romance.png" />
                <h6 class="titulo">União Entre Inimigos</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 4 -->
