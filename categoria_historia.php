...
<body background="imagens/fundo.png">
    ...
    <div class="bg-light container container-frontal2" style="border: 3px solid brown; width: 900px;">
        <h1 style="border-bottom: 5px dotted brown">Livros de História</h1>
        <div class="row"> <!-- Início Row 1 -->
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/1808_historia.png" />
                <h6 class="titulo">1808</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/1822_historia.png" />
                <h6 class="titulo">1822</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/a_historia_do_brasil_historia.png" />
                <h6 class="titulo">A História do Brasil</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Row Row 1 -->
        <div class="row"> <!-- Início Row 2 -->
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/a_historia_secreta_do_ocidente_historia.png" />
                <h6 class="titulo">A História Secreta do Ocidente</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/apologia_da_historia.png" />
                <h6 class="titulo">Apologia da História</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/diarios_da_descoberta_da_america_historia.png" />
                <h6 class="titulo">Diários da Descoberta da América</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 2 -->
        <div class="row"> <!-- Início Row 3 -->
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/grandes_mulheres_da_historia.png" />
                <h6 class="titulo">Grandes Mulheres da História</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/historia_da_quimica_historia.png" />
                <h6 class="titulo">História da Química</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4 catalogo-historia">
                <img src="imagens/Historia/revolucao_industrial_historia.png" />
                <h6 class="titulo">Revolução Industrial</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 3 -->
        <div class="row"> <!-- Início Row 4 -->
            <div class="col-md-4">
                <img src="imagens/Historia/toda_a_historia.png" />
                <h6 class="titulo">Toda a História</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Historia/uma_breve_historia_das_guerras_historia.png" />
                <h6 class="titulo">Uma Breve História das Guerras</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
            <div class="col-md-4">
                <img src="imagens/Historia/uma_historia_do_mundo_historia.png" />
                <h6 class="titulo">Uma História do Mundo</h6>
                <h6 class="preco">R$ 9,99</h6>
                <button style="margin: 20px" class="btn btn-lg btn-info" type="submit">Comprar</button>
            </div>
        </div> <!-- Fim Row 4 -->
